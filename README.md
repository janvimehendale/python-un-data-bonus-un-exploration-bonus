...
These exercises will be using the gdp_and_internet_use DataFrame that you created for the regular exercises, meaning that it will have columns for Country, Year,GDP_Per_Capita, and Internet_Users_Pct.
...
2. Group gdp by both Year and Continent and find the min, median, and max values for both gdp per capita and internet use. Hint: You may want to use the [agg method](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.agg.html).  
